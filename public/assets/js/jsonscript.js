			...
			"data":[
				{
					...
					"customer_image" : "assets/img/profiles/avatar.png",
					...
					"rating" : "4.2",
					"owner" : "Hendry Milner",
					"owner_image": "assets/img/profiles/avatar.png",
					"status" : "0",
					"Action" : ""
				},
				{
		...
		$('#deal_list').DataTable({
				...
				initComplete: (settings, json)=>{
					...
					$('.dataTables_length').appendTo('.datatable-length');
									...
									"data": [
										{
											...
											"Deal_Value": "₹4,51,000",
											"tag1": "win",
											"close_date": "25 Jan 2025",
											"created_date" : "21 Jan 2025, 01:22 pm",
											"owner" : "Amit Pardeshi",
											"source" : "Paid Social",
											"Probability": "90%",
											"Status": "0"
								...
								"columns": [
									{ "render": function ( data, type, row ){		return '<label class="checkboxs"><input type="checkbox"><span class="checkmarks"></span></label>';
				}},
				{ "render": function ( data, type, row ){
					return '<div class="set-star rating-select"><i class="fa fa-star"></i></div>';
				}},
				...
				{ "render": function ( data, type, row ){
					if(row['tag1'] == "win") { 
						...
						var status_name = "Win"; 
					} else if(row['tag1'] == "hot property") { 
						var class_name = "badge-warning-light";
						var status_name = "Hot Property"; 
					} else { 
						var class_name = "badge-danger-light";
						var status_name = row['tag1']; 
					}
					return '<span class="badge badge-tag '+class_name+'" >'+status_name+'</span>';
				}},
				{ "data": "close_date" },
				...
				"data":[
					{
						...
						"mem_image1" : "assets/img/profiles/avatar.png",
						"mem_image2": "assets/img/profiles/avatar.png",
						"mem_image3": "assets/img/profiles/avatar.png",
			...
			"data":[
				{
					...
					"lead_img" : "assets/img/profiles/avatar.png",
					"phone" : "+1 124547845",
					...
					"data":[
						{
							...
							"si_no" : "",
							"select" : "",
							"customer_name" : "Balram  jha",
							"customer_image" : "/assets/img/profiles/avatar.png",
							"customer_no" : "HDFC Branch Manager",
							"phone" : "1234567890",
							"email" : "balram@hdfc.com",
							"location" : "India",
						...
						},
						{
							...
							"si_no" : "",
							"select" : "",
							"customer_name" : "Pratik Bagwe",
							"customer_image" : "/assets/img/profiles/avatar.png",
							"customer_no" : "BOB Branch Manager",
							"phone" : "989757485",
							"email" : "pratik@bob.com",
							"location" : "mumbai",
				...
				"data":[
					{
						...
						"assigned_image" : "assets/img/profiles/avatar.png",
